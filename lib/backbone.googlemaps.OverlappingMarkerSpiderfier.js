...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['backbone', 'underscore', 'overlappingmarkerspiderfier', 'jquery'], factory);
  }
  else {
    // Browser globals
    factory(root.Backbone, root._, root.OverlappingMarkerSpiderfier, root.jQuery || root.Zepto || root.ender);
  }
}(this, function(Backbone, _, OverlappingMarkerSpiderfier, $) {
  ...
  GoogleMaps.Location = Backbone.Model.extend({
	...
	parse: function(response) {
		this.defaults.lat = response.in_latitude;
		this.defaults.lng = response.in_longitude;
		this.defaults.title = response.in_name;
		return response;
	},
    select: function() {

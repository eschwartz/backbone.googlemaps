...
(function(root, factory) {
  ...
  /**
   * GoogleMaps.PolyLineview
   * -------------------------------
   * A polyline between two places
   */
  GoogleMaps.PolyLineView = GoogleMaps.MapView.extend({
    //TODO Insert
  });
  ...
  GoogleMaps.MarkerRouteCollectionView = GoogleMaps.MarkerCollectionView.extend({
    ...
    render: function() {
      GoogleMaps.MarkerCollectionView.prototype.render.apply(this, arguments);
